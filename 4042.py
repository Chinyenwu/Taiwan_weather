...
WL2 = [[float(0.1) for i in range(9)] for j in range(6)];
WL3 = [[float(0.1) for i in range(6)] for j in range(9)];
OL = [float(0.1) for j in range(6)];

err=err1=err2=err3=err4=err5=err6=err7=err8=err9=err10=err11=err12=err13 = 10.0;
errtm  = 0;
while abs(err) >  0.001:
	for i in range(1,32,1):
		...
		for j in range(6):
			output = b3+HL2[0]*WL3[0][j]+HL2[1]*WL3[1][j]+HL2[2]*WL3[2][j]+HL2[3]*WL3[3][j]+HL2[4]*WL3[4][j]+HL2[5]*WL3[5][j]+HL2[6]*WL3[6][j]+HL2[7]*WL3[7][j]+HL2[8]*WL3[8][j];
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2010[i][8])-HL3[j]));	
				
		for j in range(9):
			ERRH2[j]=(HL2[j]*(1-HL2[j])*(WL3[j][0]*ERRH3[0]+WL3[j][1]*ERRH3[1]+WL3[j][2]*ERRH3[2]+WL3[j][3]*ERRH3[3]+WL3[j][4]*ERRH3[4]+WL3[j][5]*ERRH3[5]));					
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2011[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2012[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2013[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2014[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2015[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2016[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2017[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2018[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2019[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2020[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2021[i][8])-HL3[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3[j]=(HL3[j]*(1-HL3[j])*(float(list2022[i][8])-HL3[j]));
	...
	for l in range(1,32,1):
		err5 = err5 + (b1+float(list2014[l][1])*WL3[0][0]+float(list2014[l][3])*WL3[1][0]+float(list2014[l][5])*WL3[2][0]+float(list2014[l][7])*WL3[3][0]+float(list2014[l][13])*WL3[4][0]+float(list2014[l][14])*WL3[5][0])-float(list2014[l][8]);
	...
	#print(rate);
print("=======================================================================");	
print("err of max temperature in Taiwan is %.4f"%(err));
for l in range(1,32,1):
...
WL2WS = [[float(0.1) for i in range(9)] for j in range(6)];
WL3WS = [[float(0.1) for i in range(6)] for j in range(9)];
OLWS = [float(0.1) for j in range(6)];
...
while abs(err) > 0.5 :
	for i in range(1,32,1):
		...
		for j in range(6):
			output = b3WS+HL2WS[0]*WL3WS[0][j]+HL2WS[1]*WL3WS[1][j]+HL2WS[2]*WL3WS[2][j]+HL2WS[3]*WL3WS[3][j]+HL2WS[4]*WL3WS[4][j]+HL2WS[5]*WL3WS[5][j]+HL2WS[6]*WL3WS[6][j]+HL2WS[7]*WL3WS[7][j]+HL2WS[8]*WL3WS[8][j];
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2010[i][16])-HL3WS[j]));				
			
		
		for j in range(9):
			ERRH2WS[j]=(HL2WS[j]*(1-HL2WS[j])*(WL3WS[j][0]*ERRH3WS[0]+WL3WS[j][1]*ERRH3WS[1]+WL3WS[j][2]*ERRH3WS[2]+WL3WS[j][3]*ERRH3WS[3]+WL3WS[j][4]*ERRH3WS[4]+WL3WS[j][5]*ERRH3WS[5]));					
		...
		for j in range(6):
			output = b3WS+HL2WS[0]*WL3WS[0][j]+HL2WS[1]*WL3WS[1][j]+HL2WS[2]*WL3WS[2][j]+HL2WS[3]*WL3WS[3][j]+HL2WS[4]*WL3WS[4][j]+HL2WS[5]*WL3[5][j]+HL2WS[6]*WL3WS[6][j]+HL2WS[7]*WL3[7][j]+HL2[8]*WL3[8][j];
			HL3WS[j]=(1/(1+math.exp(output)));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2011[i][16])-HL3WS[j]));
		...
		for j in range(9):
			output = b1WS+float(list2012[i][1])*WL2WS[0][j]+float(list2012[i][3])*WL2WS[1][j]+float(list2012[i][5])*WL2WS[2][j]+float(list2012[i][7])*WL2WS[3][j]+float(list2012[i][13])*WL2WS[4][j]+float(list2010[i][14])*WL2WS[5][j];
			HL2WS[j]=(1/(1+math.exp(output)));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2012[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2014[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2015[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2016[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2017[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2018[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2019[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2020[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2021[i][16])-HL3WS[j]));
		...
		for j in range(6):
			if err > 0 :
				...
				ERRH3WS[j]=(HL3WS[j]*(1-HL3WS[j])*(float(list2022[i][16])-HL3WS[j]));
	...
	for l in range(1,32,1):
		err = err + (b1WS+float(list2010[l][1])*WL3WS[0][0]+float(list2010[l][3])*WL3WS[1][0]+float(list2010[l][5])*WL3WS[2][0]+float(list2010[l][7])*WL3WS[3][0]+float(list2010[l][13])*WL3WS[4][0]+float(list2010[l][14])*WL3WS[5][0])-float(list2010[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2011[l][1])*WL3WS[0][0]+float(list2011[l][3])*WL3WS[1][0]+float(list2011[l][5])*WL3WS[2][0]+float(list2011[l][7])*WL3WS[3][0]+float(list2011[l][13])*WL3WS[4][0]+float(list2011[l][14])*WL3WS[5][0])-float(list2011[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2012[l][1])*WL3WS[0][0]+float(list2012[l][3])*WL3WS[1][0]+float(list2012[l][5])*WL3WS[2][0]+float(list2012[l][7])*WL3WS[3][0]+float(list2012[l][13])*WL3WS[4][0]+float(list2012[l][14])*WL3WS[5][0])-float(list2012[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2013[l][1])*WL3WS[0][0]+float(list2013[l][3])*WL3WS[1][0]+float(list2013[l][5])*WL3WS[2][0]+float(list2013[l][7])*WL3WS[3][0]+float(list2013[l][13])*WL3WS[4][0]+float(list2013[l][14])*WL3WS[5][0])-float(list2013[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2014[l][1])*WL3WS[0][0]+float(list2014[l][3])*WL3WS[1][0]+float(list2014[l][5])*WL3WS[2][0]+float(list2014[l][7])*WL3WS[3][0]+float(list2014[l][13])*WL3WS[4][0]+float(list2014[l][14])*WL3WS[5][0])-float(list2014[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2015[l][1])*WL3WS[0][0]+float(list2015[l][3])*WL3WS[1][0]+float(list2015[l][5])*WL3WS[2][0]+float(list2015[l][7])*WL3WS[3][0]+float(list2015[l][13])*WL3WS[4][0]+float(list2015[l][14])*WL3WS[5][0])-float(list2015[l][16]);
		
	for l in range(1,32,1):
		err = err + (b1WS+float(list2016[l][1])*WL3WS[0][0]+float(list2016[l][3])*WL3WS[1][0]+float(list2016[l][5])*WL3WS[2][0]+float(list2016[l][7])*WL3WS[3][0]+float(list2016[l][13])*WL3WS[4][0]+float(list2016[l][14])*WL3WS[5][0])-float(list2016[l][16]);
		
	for l in range(1,32,1):
		err = err + (b1WS+float(list2017[l][1])*WL3WS[0][0]+float(list2017[l][3])*WL3WS[1][0]+float(list2017[l][5])*WL3WS[2][0]+float(list2017[l][7])*WL3WS[3][0]+float(list2017[l][13])*WL3WS[4][0]+float(list2017[l][14])*WL3WS[5][0])-float(list2017[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2018[l][1])*WL3WS[0][0]+float(list2018[l][3])*WL3WS[1][0]+float(list2018[l][5])*WL3WS[2][0]+float(list2018[l][7])*WL3WS[3][0]+float(list2018[l][13])*WL3WS[4][0]+float(list2018[l][14])*WL3WS[5][0])-float(list2018[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2019[l][1])*WL3WS[0][0]+float(list2019[l][3])*WL3WS[1][0]+float(list2019[l][5])*WL3WS[2][0]+float(list2019[l][7])*WL3WS[3][0]+float(list2019[l][13])*WL3WS[4][0]+float(list2019[l][14])*WL3WS[5][0])-float(list2019[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2020[l][1])*WL3WS[0][0]+float(list2020[l][3])*WL3WS[1][0]+float(list2020[l][5])*WL3WS[2][0]+float(list2020[l][7])*WL3WS[3][0]+float(list2020[l][13])*WL3WS[4][0]+float(list2020[l][14])*WL3WS[5][0])-float(list2020[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2021[l][1])*WL3WS[0][0]+float(list2021[l][3])*WL3WS[1][0]+float(list2021[l][5])*WL3WS[2][0]+float(list2021[l][7])*WL3WS[3][0]+float(list2021[l][13])*WL3WS[4][0]+float(list2021[l][14])*WL3WS[5][0])-float(list2021[l][16]);

	for l in range(1,32,1):
		err = err + (b1WS+float(list2022[l][1])*WL3WS[0][0]+float(list2022[l][3])*WL3WS[1][0]+float(list2022[l][5])*WL3WS[2][0]+float(list2022[l][7])*WL3WS[3][0]+float(list2022[l][13])*WL3WS[4][0]+float(list2022[l][14])*WL3WS[5][0])-float(list2022[l][16]);	
...
print("=======================================================================");	
print("err of max windspeed in Taiwan is %.4f"%(err));
for l in range(1,32,1):
